...
//ou 8 para entrar o nr. 1 ou 9 para seleciona o DATA_Out
...
#define ADDN 38		// "100110"; -- ADDN Rx, Ry, #N			-- Rx <- Ry + #N		Format: < inst(6) | Rx(3) | Ry(3) |XXXXXXXXXX> \n < Number(16) >
...
loop:
	...
	//printf("OP: %d, M3: %d, M4: %d, ResultadoUla: %d\n", OP, M3, M4, resultadoUla.result);
